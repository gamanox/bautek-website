({
  ...
  detalles: [
    ...
    { nombre: "direccion", texto: "Lorem Ipsum" },
    { nombre: "construccion", texto: "220 m2" },
    { nombre: "terreno", texto: "200 m2" },
    { nombre: "plantas", texto: "2" },
    { nombre: "recamaras", texto: "3 Recámaras" },
    { nombre: "banos", texto: "3 1/2 baños" },
    { nombre: "inversion", texto: "Desde $3’500,000" }
  ],
