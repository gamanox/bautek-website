{
		...
		$background_homepage_type: 'image',
		background_homepage: '/remote/direct_uploads/1540408691_background-homepage.jpg',
	slides: [
		{
			header: 'EN BAUTEK CONSTRUIMOS LA CASA DE TUS SUEÑOS',
			tagline: 'Comprueba que somos la mejor opción para construir tu hogar en Saltillo.',
			call_to_action: 'Scroll down to see what\'s up',
		},
		{
			header: 'LO QUE HACEMOS',
			tagline: 'Inovación y calidad en construcción',
			call_to_action: 'Scroll down to see what\'s up',
		},
		{
			header: 'CASAS A TU MEDIDA',
			tagline: 'Diseñamos tu casa de acuerdo a tu gusto y estilo.',
			call_to_action: 'Scroll down to see what\'s up',
		},
		{
			header: 'CASAS EN VENTA',
			tagline: 'Vive los mejores momentos de tu vida en tu nueva casa.',
			call_to_action: 'Scroll down to see what\'s up',
		}
	],
	instruction_points: [
